...
This document describes all configuration variables used in AnvuMusic. These can be set as environment variables or in a `.env` file in the project root.
...
| `SUPPORT_CHAT` | `https://t.me/+t4FSZuy7t_VmOWE9` | **Full URL** to the support group. |
| `SUPPORT_CHANNEL`| `https://t.me/ECHOWAVESUPPORT` | **Full URL** to the announcement channel. |
