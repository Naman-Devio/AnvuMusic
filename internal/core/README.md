# 🏛️ AnvuMusic Core Package

The `core` package is the central orchestration and state management layer of the AnvuMusic bot. It maintains the real-time status of active playback sessions (Rooms), tracks chat-specific properties (ChatState), and manages the lifecycle of Telegram assistant accounts.
