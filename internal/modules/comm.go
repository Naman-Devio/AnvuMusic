...
var AllCommands = BotCommands{
	...
	GroupUserCommands: []*telegram.BotCommand{
		...
		{Command: "help", Description: "Show help menu."},
		{Command: "ping", Description: "Check if the bot is alive."},
		{Command: "alive", Description: "Check bot status with system info."},
		{Command: "id", Description: "Get Telegram IDs."},
		{Command: "afk", Description: "Mark yourself as AFK."},
		{Command: "truth", Description: "Get a random truth question."},
		{Command: "dare", Description: "Get a random dare challenge."},
		{Command: "paste", Description: "Paste text to a paste service."},
	},
	GroupAdminCommands: []*telegram.BotCommand{
		...
		{Command: "welcome", Description: "Toggle welcome/goodbye messages."},
		{Command: "filter", Description: "Set keyword auto-reply filter."},
		{Command: "filters", Description: "List all filters."},
		{Command: "stopfilter", Description: "Remove a keyword filter."},
		{
			Command:     "channelplay",
